...
// GMSM2KeyGenOpts contains options for ECDSA public key importation in PKIX format
...
// GMSM4KeyGenOpts contains options for ECDSA secret key importation in DER format
// or PKCS#8 format.
